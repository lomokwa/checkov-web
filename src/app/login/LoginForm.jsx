...
export default function LoginForm() {
  ...
  return(
    <section className="bg-rose-900 p-6 rounded-lg max-w-[420px] w-full mx-auto">
      <form onSubmit={handleLogin} className="flex flex-col items-start justify-around min-h-[25vh]">
        ...
        <input type="submit" value="Login" className="w-full bg-amber-400 text-gray-900 py-2 px-8 rounded-lg shadow-lg transition duration-300 hover:bg-amber-500 hover:shadow-sm cursor-pointer"/>
      </form>
